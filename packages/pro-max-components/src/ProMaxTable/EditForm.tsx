...
import { useEditFormRef, useMode, useOpen, useFormOptions, useEditRecord } from './hooks';
...
import type { ProMaxColumns } from './type.d';
...
const Item = React.memo(
  (
    ...
    const handleOptionsChange = useMemoizedFn((options: any[], key?: string) => {
...
const EditForm: React.FC<(ModalFormProps | DrawerFormProps) & EditFormProps> = ({
  editFormType = 'modal',
  columns,
  onEditFormSubmit,
  ...
  const handle = React.useCallback(() => {
    if (open && mode === 'edit' && editFormRef?.current && editRecord && formOptions) {
